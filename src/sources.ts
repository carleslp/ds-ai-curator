...
export const curatedSources: CuratedSource[] = [
  ...
  { name: "Adobe React Spectrum Releases", url: "https://github.com/adobe/react-spectrum/releases.atom", kind: "rss", tier: tier1, sourceScore: 5 },
  { name: "GitHub Design Engineering", url: "https://github.blog/category/engineering/", kind: "html", tier: tier1, sourceScore: 5 },
  { name: "Material Web Releases", url: "https://github.com/material-components/material-web/releases.atom", kind: "rss", tier: tier1, sourceScore: 5 },
  { name: "IBM Carbon Releases", url: "https://github.com/carbon-design-system/carbon/releases.atom", kind: "rss", tier: tier1, sourceScore: 5 },
  ...
  { name: "Design Systems Collective", url: "https://medium.com/feed/design-systems-collective", kind: "rss", tier: tier1, sourceScore: 5 },
  { name: "UX Collective", url: "https://uxdesign.cc/feed", kind: "rss", tier: tier2, sourceScore: 4 },
  { name: "Sparkbox Foundry", url: "https://sparkbox.com/foundry/feed", kind: "rss", tier: tier2, sourceScore: 4 },
  { name: "Brad Frost", url: "https://bradfrost.com/feed/", kind: "rss", tier: tier2, sourceScore: 4 },
  ...
  { name: "Into Design Systems", url: "https://intodesignsystems.com/", kind: "html", tier: tier2, sourceScore: 4 },
  { name: "Frontend Masters", url: "https://frontendmasters.com/blog/", kind: "html", tier: tier3, sourceScore: 3 },
  { name: "Syntax FM", url: "https://syntax.fm/", kind: "html", tier: tier3, sourceScore: 3 },
  { name: "Latent Space", url: "https://www.latent.space/", kind: "html", tier: tier2, sourceScore: 4 },
